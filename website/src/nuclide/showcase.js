...
var featured = [
  ...
  },
  {
    ...
    author: 'Facebook',
    blogs: [
      "https://code.facebook.com/posts/1014532261909640/nuclide-bringing-modern-web-techniques-to-mobile/",
      "https://code.facebook.com/posts/1189117404435352/nuclide-for-android-how-we-built-the-first-cross-platform-nuclide-app/",
      "https://code.facebook.com/posts/435862739941212/making-nuclide-apps-accessible/",
    ],
  },
  {
  ...
  },
  {
    ...
    blog: [
      "https://medium.com/ios-os-x-development/an-ios-developer-on-nuclide-1f24786c29f0",
    ],
  },
  {
    name: 'Exponent',
...
var apps = [
  ...
  },
  {
    ...
    blogs: [
      'https://medium.com/formations-factory/creating-company-name-search-app-with-nuclide-36a049b0848d',
    ],
  },
  {
    name: 'DareU',
      ...
      <Site section="showcase" title="Showcase">
        <section className="content wrap documentationContent nosidebar showcaseSection">
          <div className="inner-content showcaseHeader">
            <h1 style={{textAlign: 'center'}}>Apps using Nuclide</h1>
            <div className="subHeader"></div>
            <p>The following is a list of some of the public apps using <strong>Nuclide</strong> and are published on the Apple App Store or the Google Play Store. Not all are implemented 100% in Nuclide -- many are hybrid native/Nuclide. Can you tell which parts are which? :)</p>
            <p>Want to add your app? Found an app that no longer works or no longer uses Nuclide? Please submit a pull request on <a href="https://github.com/facebook/nuclide">GitHub</a> to update this page!</p>
          </div>

          <div className="inner-content showcaseHeader">
            <h1 style={{textAlign: 'center'}}>Featured Apps</h1>
            <div className="subHeader"></div>
            <p>These are some of the most well-crafted Nuclide apps that we have come across.<br/>Be sure to check them out to get a feel for what Nuclide is capable of!</p>
          </div>
