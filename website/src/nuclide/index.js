  ...
  render: function() {
    return (
      <Site>
        <div className="hero">
          <div className="wrap">
            <div className="text"><strong>Nuclide</strong></div>
        ...
        <section className="content wrap">
          ...
          <div className="buttons-unit">
            <a href="docs/getting-started.html#content" className="button">Get started with Nuclide</a>
          </div>
          ...
          <p>
            With Nuclide, you can use the standard platform components such as UITabBar on iOS and Drawer on Android.  This gives your app a consistent look and feel with the rest of the platform ecosystem, and keeps the quality bar high.  These components are easily incorporated into your app using their React component counterparts, such as TabBarIOS and DrawerLayoutAndroid.
          </p>
          <Prism>
{`// iOS

var React = require('nuclide');
...
var App = React.createClass({
  render: function() {
    return (
      <TabBarIOS>
        <TabBarIOS.Item title="Nuclide" selected={true}>
          <NavigatorIOS initialRoute={{ title: 'Nuclide' }} />
        </TabBarIOS.Item>
      </TabBarIOS>
    );
  },
...
var App = React.createClass({
  render: function() {
    return (
      <DrawerLayoutAndroid
        renderNavigationView={() => <Text>Nuclide</Text>}>
        <ProgressBarAndroid />
      </DrawerLayoutAndroid>
    );
  },
          ...
          <p>
            All operations between the JavaScript application code and the native platform are performed asynchronously, and the native modules can also make use of additional threads as well.  This means we can decode images off of the main thread, save to disk in the background, measure text and compute layouts without blocking the UI, and more.  As a result, Nuclide apps are naturally fluid and responsive.  The communication is also fully serializable, which allows us to leverage Chrome Developer Tools to debug the JavaScript while running the complete app, either in the simulator or on a physical device.
          </p>
          <p>
            See <a href="docs/debugging.html#content">Debugging</a>.
          </p>
          <img src="/nuclide/img/chrome_breakpoint.png" width="800" height="443" />

          <h2>Touch Handling</h2>
          <p>
            Nuclide implements a powerful system to negotiate touches in complex view hierarchies and provides high level components such as TouchableHighlight that integrate properly with scroll views and other elements without any additional configuration.
          </p>
          <Prism>
{`// iOS & Android
    ...
    return (
      <ScrollView>
        <TouchableHighlight onPress={() => console.log('pressed')}>
          ...
          <p>
            Laying out views should be easy, which is why we brought the flexbox layout model from the web to Nuclide.  Flexbox makes it simple to build the most common UI layouts, such as stacked and nested boxes with margin and padding.  Nuclide also supports common web styles, such as fontWeight, and the StyleSheet abstraction provides an optimized mechanism to declare all your styles and layout right along with the components that use them and apply them inline.
          </p>
          <Prism>
{`// iOS & Android
...
module.exports = MyCustomView;`}
          ...
          <p>
            To create a simple module in Android, create a new class that extends the ReactContextBaseJavaModule class, and annotate the function that you want to make available to JavaScript with @ReactMethod. Additionally, the class itself must be registered in the ReactPackage of your Nuclide application.
          </p>
          <Prism>
{`// Java
